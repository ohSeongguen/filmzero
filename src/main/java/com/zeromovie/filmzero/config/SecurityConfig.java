...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.authorizeRequests()
                .mvcMatchers("/", "/member/**", "/item/**", "/image/**","/images/**", "/login/**", "/main/**",
        ...
        http.exceptionHandling().authenticationEntryPoint(new CustomAuthenticationEntryPoint());// 인증되지 않은 사용자가 접근할 경우 수행되는 작업
    }
